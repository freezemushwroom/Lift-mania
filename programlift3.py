import tkinter as bk  # update sudah ditambahkan

# apabila kit amembuat object labelframe dan tidak menyebutkan windownya(master),
# maka secara otomatis labelframe tersebut akan diassign pada window yang dibuat paling awal
# sama seperti window, kita bisa membuat object labelframe sebanyak yang kita mau

# fitur tidak akan diupdate
